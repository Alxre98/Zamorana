    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative py-24 md:py-32 lg:py-40 overflow-hidden">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-6xl h-full">
          ...
          <div className="absolute -bottom-20 left-1/3 w-64 h-64 bg-cyan-100 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob animation-delay-4000"></div>
        </div>

        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <div className="inline-flex items-center justify-center w-20 h-20 mb-6 rounded-full bg-blue-50 border-2 border-blue-100">
              <svg
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
              Contácta <span className="text-blue-600">Zamorana</span>
            </h1>
            <div className="max-w-3xl mx-auto">
              <p className="text-lg md:text-xl text-gray-600 max-w-2xl mx-auto">
                Estamos aquí para responder tus preguntas y escuchar tus comentarios sobre nuestro proyecto de sonidos naturales.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div className="p-6 bg-white rounded-xl shadow-sm">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-1">Correo Electrónico</h3>
            ...
            <div className="p-6 bg-white rounded-xl shadow-sm">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-1">Ubicación</h3>
