...
export default function AudioPlayer({ src, title, description, timeOfDay, location, date }: AudioPlayerProps) {
      ...
      <div className="p-6">
        <div className="flex justify-between items-start mb-4">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">{location} • {date}</p>
          </div>
          <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium ${timeOfDayColors[timeOfDay]}`}>
            {timeOfDay}
          </span>
        </div>
