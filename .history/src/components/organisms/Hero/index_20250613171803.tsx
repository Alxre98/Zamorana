    ...
    <div className="relative min-h-screen bg-white overflow-hidden flex items-center justify-center">
      <div className="relative w-full max-w-4xl px-6 mx-auto text-center">
        ...
        <div className="flex flex-col items-center">
          ...
          {/* Texto by artikko más grande y pegado al logo */}
          <h1 className="text-4xl md:text-5xl font-light tracking-tight text-black -mt-2">
            <span className="inline-block align-middle text-3xl md:text-4xl font-sans not-italic font-light mr-2">
              by
            </span>
