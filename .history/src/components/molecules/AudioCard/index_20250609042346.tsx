...
// Custom type to extend HTMLDivElement with our specific ARIA attributes
interface ProgressBarDivElement extends React.HTMLAttributes<HTMLDivElement> {
...
const ProgressBar: React.FC<ProgressBarProps> = ({
  ...
  const progressBarProps: ProgressBarDivElement = {
