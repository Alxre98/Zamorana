    ...
    >
      ...
      <div className="relative">
        ...
        <div className="relative z-10 p-4">
          ...
          {/* Progress bar */}
          {/* @ts-expect-error - ARIA attributes type mismatch */}
          <div
            className="h-1 bg-gray-100 rounded-full overflow-hidden mb-2"
            role="progressbar"
            ...
            aria-atomic="true"
          >
            <div className={`${styles.progressBarFilled} w-[${progress}%]`} />
          </div>
