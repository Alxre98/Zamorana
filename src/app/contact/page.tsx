    ...
    <div className="bg-white">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-white to-emerald-50">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          {/* Decorative elements */}
          <div className="absolute top-10 right-10 w-32 h-32 text-green-200 opacity-70 transform -rotate-12">
          ...
          <div className="absolute bottom-20 left-10 w-40 h-40 text-emerald-200 opacity-60 transform rotate-15">
            <svg viewBox="0 0 100 100" fill="currentColor">
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-gray-900 mb-6 leading-tight">
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-600 to-emerald-600">Contáctanos</span>
            <span className="block">en Zamorana</span>
          </h1>
